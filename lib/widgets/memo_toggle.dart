            ...
            child: Row(
              children: [
                Icon(
                  ...
                  size: 14,
                  color: hasMemo ? AppColors.merah : AppColors.kayuLight,
                ),
                ...
                if (hasMemo) ...[
                  ...
                  Container(width: 4, height: 4, decoration: const BoxDecoration(
                    color: AppColors.merah, shape: BoxShape.circle)),
                ],
                const Spacer(),
                Text(
                  _open ? '닫기 ▴' : '▾',
                  style: const TextStyle(fontSize: 10, color: AppColors.kayuLight),
                ),
              ],
            ),
          ),
                    ...
                    child: Column(
                      ...
                      children: [
                        TextField(
                          ...
                          maxLines: null,
                          minLines: 2,
                          style: const TextStyle(fontSize: 12, color: AppColors.kayu, height: 1.4),
