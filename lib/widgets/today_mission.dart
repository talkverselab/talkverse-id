...
import 'indo_decor.dart';

/// Today's Mission 카드 — 현재 진행 중인 레슨 표시 (열대 산·야자 일러스트 + progress).
    ...
    return InkWell(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: AppColors.merah.withValues(alpha: 0.3),
              blurRadius: 12,
              ...
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(color: AppColors.emasDeep, width: 0.6),
                        ),
                        child: Text(
                          level,
                      ...
                      const BadgeStamp(text: 'HARI', size: 24),
                    ],
                  ),
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      fontSize: 13,
                      color: AppColors.gading.withValues(alpha: 0.85),
                      letterSpacing: 0.5,
                    ),
                  ),
                  ...
                  Stack(
                    children: [
                      Container(
                        height: 8,
                        decoration: BoxDecoration(
                          color: AppColors.gading.withValues(alpha: 0.25),
                          border: Border.all(color: AppColors.emas, width: 0.6),
                        ),
                      ),
...
class _MountainPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // 깃발
    final flag = Paint()..color = AppColors.emasBright;
    canvas.drawRect(
